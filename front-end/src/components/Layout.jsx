  ...
  return (
    <div className="meal-body">
      <div className="meal-header">
        <div className="meal-header__left">
          <div className="meal-header__logo">
            <svg
          ...
          <h3 className="meal-header__title">Welcome to Meal Sharing APP</h3>
        </div>
        <div className="meal-header__right">
          <a className="meal-header__right-item" href='/'>Home</a>
        </div>
      </div>
      {children}
